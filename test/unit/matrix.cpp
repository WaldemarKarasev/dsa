...
using s_t =lib::matrix<int, containers::vector<int>>::size_type; // ???
...
{
    matrix<int, containers::vector<int>> mat1(3, 2, {1, 2, 3, 4, 5, 6});
    matrix<int, containers::vector<int>> mat2(3, 2, {1, 2, 3, 4, 5, 6});
    matrix<int, containers::vector<int>> mat3(3, 2, {1, 1, 1, 1, 1, 1});
    matrix<int, containers::vector<int>> mat4(2, 3, {1, 2, 3, 4, 5, 6});
...
{
    matrix<int, containers::vector<int>> mat;
...
TEST(CTORS_TEST, MOVE_CTORS)
{
    ...
    matrix<int, containers::vector<int>> mat1(ROWS, COLS, {1, 2, 3, 4, 5, 6});

    s_t row = mat1.getRows();
    s_t col = mat1.getCols();
    containers::vector<int> vec_init = mat1.getBuf();

    matrix<int, containers::vector<int>> mat2(std::move(mat1));
    containers::vector<int> vec;
    ...
    matrix<int, containers::vector<int>> mat3;
    mat3 = std::move(mat2);
...
TEST(CTORS_TEST, COPY_CTORS)
{
    ...
    matrix<int, containers::vector<int>> mat2(mat1);
...
TEST(OPERATIONS, SPLICE)
{
    ...
    matrix<int, containers::vector<int>> mat1(ROWS, COLS, {1, 2, 3, 4, 5, 6});
    matrix<int, containers::vector<int>> mat2(ROWS-1, COLS-1, {5, 6});
    matrix<int, containers::vector<int>> mat3 = mat1.splice(1, 1);
...
{
    matrix<int, containers::vector<int>> mat1(3, 3, {13, 3, 4, 43, 76, 3, 4, 4, 3});
...
{
    matrix<int, containers::vector<int>> mat1(2, 2, {1, 1, 1, 1});
    matrix<int, containers::vector<int>> mat2(2, 2, {1, 1, 1, 1});
    matrix<int, containers::vector<int>> mat3(2, 2, {2, 2, 2, 2});

    matrix<int, containers::vector<int>> res = mat1 + mat2;
...
{
    matrix<int, containers::vector<int>> mat1(1, 2, {2, 4});
    matrix<int, containers::vector<int>> mat2(2, 1, {1, 9});
    matrix<int, containers::vector<int>> mat3(1, 1, {38});
